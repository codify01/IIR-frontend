...
import img1 from "../../assets/image/img15.png"
...
const ServiceLogin: React.FC = () => {
	...
	return (
		<div className={`h-[100vh] flex items-center justify-center relative`} style={bgImage}>
			<div className="container h-ful px-5">
				...
				<div className="md:gap-0 gap-5 md:pb-0 pb-10 h-5/6 flex lg:flex-row flex-col-reverse justify-center items-center">
					<div className="lg:w-1/2 md:w-2/3 w-full">
						<h3 className="text-2xl text-center my-5 font-bold">Log In to Service Account</h3>
						<form
