            ...
            >
              ...
              <div className="grid gap-2 md:col-span-1 col-span-2">
                ...
                <div className="bg-[#2F53181A] input1 flex items-center pe-3">
                  ...
                  />
                  <FaEye
                    className={`cursor-pointer ${isVisible1 ? 'hidden' : 'block'}`}
                    onClick={() => setVisibility1(true)}
                  />
                  <FaEyeSlash
                    className={`cursor-pointer ${isVisible1 ? 'block' : 'hidden'}`}
              ...
              <div className="grid gap-2 md:col-span-1 col-span-2">
                ...
                <div className="bg-[#2F53181A] input1 flex items-center pe-3">
                  ...
                  />
                  <FaEye
                    className={`cursor-pointer ${isVisible2 ? 'hidden' : 'block'}`}
                    onClick={() => setVisibility2(true)}
                  />
                  <FaEyeSlash
                    className={`cursor-pointer ${isVisible2 ? 'block' : 'hidden'}`}
              ...
              <div className="grid gap-2 col-span-2">
                ...
                {formik.touched.referral_code && formik.errors.referral_code && (
                  <p className="text-red-500 text-sm">{formik.errors.referral_code}</p>
                )}
              </div>
